    ...
    <body>       
        ...
        <div class="container mt-4 col-lg-4">
            <div class="card col-sm-10">
                <div class="card-body">
                    <form class="form-sign" action="ControladorUsuarios?accion=Actualizar&id=${alumno.getId()}" method="POST">
                        ...
                        <div class="form-group mb-1">
                            <label>Nombre</label>
                            <input type="text" name="txtnombre" value="${alumno.getNombre()}" class="form-control">
                        </div>
                        <div class="form-group mb-1">
                            <label>Apellido</label>
                            <input type="text" name="txtapellido" value="${alumno.getApellido()}" class="form-control">
                        </div>
                        <div class="form-group mb-1">
                            <label>Email</label>
