    ...
    <body>    
        ...
        <div class="container mt-4 col-lg-6">
            <div class="card col-sm-10">
                <div class="card-body">
                    <form class="form-sign" action="ControladorPedidos" method="POST">
                        <div class="form-group text-center mb-1">
                            <input type="hidden" value="${fechaCompra}" name="hidefecha">
                            <input type="hidden" value="${monto}" name="hidemonto">
                            <input type="hidden" value="${estado}" name="hideestado">
                            <input type="hidden" value="${idCompra}" name="hideidCompra">
                            <input type="hidden" value="${idAlumno}" name="hideidAlumno">
                            <input type="hidden" value="${idpago}" name="hideidpago">
                            <h3>Cancelar Pedido</h3>
                            <h6>Ingrese el motivo de la cancelación del pedido. El mismo será enviado al alumno por mail.</h6>
                        </div>                        
